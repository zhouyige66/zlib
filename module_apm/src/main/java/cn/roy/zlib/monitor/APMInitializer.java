...
public final class APMInitializer {
    private volatile static APMInitializer instance;

    public static APMInitializer getInstance() {
        if (instance == null) {
            synchronized (APMInitializer.class) {
                if (instance == null) {
                    instance = new APMInitializer();
                }
            }
        }
        return instance;
